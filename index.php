	...
	<head>
		...
		<script>
			function editarTarefa(txt_tarefa,id) {
				...
				form.action = 'index.php?pag=index&acao=editarTarefa';
				form.method = 'POST';
				form.className = 'row';
			...
			function removerTarefa(id) {
				...
				location.href = `index.php?pag=index&acao=removerTarefa&id=${id}`;
			}

			function tarefaConcluida(id) {
				location.href = `index.php?pag=index&acao=tarefaFeita&id=${id}`;
			}
		</script>
	</head>
